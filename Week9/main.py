...
while not input_valid and i in range(5):
    ...
    try:
        ...
        print("Invalid input. Combat strength must be an integer.")
        i += 1
        continue

    # no longer needed when we have a try except block
...
# test
try:
    health_points = functions.monster_attacks("some string1", "some string2")
except TypeError:
